// POST { post_id, featured_title?, featured_tagline?, swap? }
// Updates the featured image's title/tagline (and bumps the background index if
// swap), clears the rendered image, then triggers the GitHub Actions render.
...
export const handler = async (event) => {
  ...
  const { post_id, featured_title, featured_tagline, swap } = body;
