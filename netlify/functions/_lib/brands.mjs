...
export const BRANDS = {
  ...
  nms: {
    ...
    leadMagnets: [
      ...
      { key: 'reality-check', label: 'The Reality Check', url: 'https://escapepreneur.com/reality-check', when: 'Already-trying-but-stuck readers, whatever their timeframe (a few months in or several years): diagnosing where they are stuck, what is not working, course-correcting an existing business.' },
    ],
    allowedLinkDomains: ['escapepreneur.com', 'jointheescapeclub.com', 'eschub.com'],
    forbiddenLinkDomains: [],
    reader: 'A woman who has already started building a freedom-based business - could be a few months in, could be several years, the timeframe is not the point. She has not gotten the money or freedom she wanted from it yet and feels stuck. She already knows a business can give her freedom; she does not need selling on that idea. What she needs is to understand why what she has tried has not worked and what to do differently. She is NOT a beginner deciding whether to start.',
    positioning: 'Point toward possibility and action. Do not re-sell freedom or explain why online business is a good idea. Link to ESC Hub only sparingly and only where directly relevant - she is earlier in the journey than the ESC Hub reader. KEYWORD SELECTION RULE (for topic/keyword research): treat any keyword centered on the DECISION to start or whether to build a business (e.g. "how to start a business", "business plan", "business for sale", "starting a business", generic beginner how-tos) as low opportunity by default - this reader has already started, so that framing signals an earlier-stage searcher than her. A clever angle alone does not rescue it. Only keep such a keyword if the suggested title/angle makes an unmistakable, credible pivot to an already-in-business reader who is stuck and restarting or course-correcting (not just a reworded hook) - hold these to a noticeably higher bar than ordinary topics and score conservatively unless that pivot is genuinely convincing.',
    special: `BEGINNER TEST: a reader who has already started must never feel talked down to or told things she already knows. Do not explain why a business/online business is a good idea - she already believes that. Do not use "escape the 9 to 5" as the hook. Do not define basic concepts without adding depth. No motivational-poster tone. She does not need re-selling on freedom; she needs a real, specific answer for why what she has tried has not worked and what to do differently - regardless of whether that's after 3 months or 5 years. NEVER STATE A SPECIFIC ELAPSED-TIME NUMBER OR RANGE for how long she has been trying (e.g. "5 to 8 years later", "5-10 years in", "3 years down the line") - this excludes anyone outside that window and the checker will hard-fail it. If time elapsed matters to the point, keep it genuinely open-ended ("however long you've been at this", "whether it's been months or years") rather than naming a number.`,
    forbiddenSell: [],
    wordMin: 1500, wordMax: 2500,
...
${brand === 'esc' ? `PRESENT THE OFFER NATURALLY: match the offer to the article and present it clearly in the BODY before the FAQ - never buried in the FAQ, never a passing footnote. WHERE ESC HUB IS A NATURAL CONCLUSION (the post is really about tool sprawl, disconnected systems, tech overwhelm, or running the whole business in one place), present ESC Hub as the recommended answer: name it and explain specifically how it brings everything into one place, with the support and the team as the real difference (not a feature list), as the conclusion the article has been building toward - honest, specific, never puffy, not telegraphed from the top. BUT DO NOT SHOEHORN ESC HUB where it isn't a natural fit: if the post is really about the COST of tools, overspending or wasting money on subscriptions, lead to the Savings Simulator as the natural next step instead. Present whichever you choose (your cta_choice) as a genuine recommendation in the body.
