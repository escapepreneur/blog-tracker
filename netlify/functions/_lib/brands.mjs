...
export const BRANDS = {
  ...
  nms: {
    ...
    special: `BEGINNER TEST: a reader who has already started must never feel talked down to or told things she already knows. Do not explain why a business/online business is a good idea - she already believes that. Do not use "escape the 9 to 5" as the hook. Do not define basic concepts without adding depth. No motivational-poster tone. She does not need re-selling on freedom; she needs a real, specific answer for why what she has tried has not worked and what to do differently - regardless of whether that's after 3 months or 5 years.`,
    forbiddenSell: [],
    wordMin: 1500, wordMax: 2500,
