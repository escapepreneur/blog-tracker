...
export async function searchPexels(term, apiKey, n = 3) {
  if (!apiKey || !term) return [];
  try {
    const url = `https://api.pexels.com/v1/search?query=${encodeURIComponent(term)}&per_page=${n}&orientation=landscape`;
